      ...
      <div className="mx-auto max-w-7xl px-3 py-6 sm:px-4 lg:px-6 lg:py-8">
        ...
        <div className="mb-6 sm:mb-8">
          ...
          <p className="text-sm text-gray-400 sm:text-base">
            Disinilah kamu dapat mengelola semua acara yang kamu buat dan
          ...
          <div className="space-y-6 sm:space-y-8">
            ...
            <div className="grid grid-cols-2 gap-3 sm:gap-4 lg:grid-cols-4 lg:gap-6">
              ...
              <StatCard
                ...
                value={
                  organizerData?.data
                    ? organizerData.data.totalRegistrations
                    : 0
                }
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-3 sm:gap-4">
              ...
              <button
                className="group rounded-xl border border-gray-700 bg-gradient-to-br from-gray-900 to-gray-800 p-4 text-left transition-all hover:border-purple-500 sm:p-6"
                ...
                {(organizerData?.data?.recentEvents ?? []).length > 0 ? (
                  ...
                  <div className="rounded-xl border border-gray-700 bg-gradient-to-br from-gray-900 to-gray-800 p-6 text-center sm:rounded-2xl sm:p-8">
                    ...
                    <p className="mb-4 text-sm text-gray-400">
                      Kamu belum membuat event terbaru. Mulai buat event
                      pertamamu untuk melihatnya di sini.
                    </p>
                    <button
                      onClick={() => router.push("/dashboard/create-event")}
